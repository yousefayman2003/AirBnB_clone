#!/usr/bin/python3
"""Module containing unit test for City Class"""
import unittest
import json
import os
...
class TestCity(unittest.TestCase):
    ...
    def test_init_no_kwargs(self):
        ...
        self.assertEqual(
            str(type(obj)), "<class 'models.city.City'>")

    def test_init_kwargs(self):
        """Test Constructor with kwargs"""
        obj = City(id=str(uuid4), created_at="2023-05-15T08:30:00.000000",
                   updated_at="2023-10-22T18:45:30.500000",
                   name="Cairo", state_id="21")
        self.assertIsInstance(obj.id, str)
        self.assertIsInstance(obj.created_at, datetime)
        self.assertIsInstance(obj.updated_at, datetime)
        self.assertIsInstance(obj.name, str)
        ...
        self.assertEqual(obj.state_id, "21")
        self.assertEqual(
            str(type(obj)), "<class 'models.city.City'>")
